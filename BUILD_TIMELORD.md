...
required to run a [Timelord](https://github.com/Equality-Network/equality-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Equality-Network/equality-blockchain/blob/main/install-timelord.sh)
