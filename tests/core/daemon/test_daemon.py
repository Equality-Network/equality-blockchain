...
from equality.util.block_tools import BlockTools
from equality.util.ints import uint16
from equality.util.ws_message import create_payload
...
class TestDaemon:
    ...
    async def test_daemon_simulation(self, simulation, get_daemon):
        ...
        data = {}
        payload = create_payload("get_blockchain_state", data, service_name, "equality_full_node")
        await ws.send_str(payload)
