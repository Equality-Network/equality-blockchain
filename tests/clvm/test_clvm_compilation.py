...
from equality.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "equality/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "equality/wallet/puzzles/cc.clvm",
        "equality/wallet/puzzles/equalitylisp_deserialisation.clvm",
        "equality/wallet/puzzles/rom_bootstrap_generator.clvm",
        "equality/wallet/puzzles/generator_for_single_coin.clvm",
        "equality/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "equality/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "equality/wallet/puzzles/lock.inner.puzzle.clvm",
        "equality/wallet/puzzles/p2_conditions.clvm",
        "equality/wallet/puzzles/p2_delegated_conditions.clvm",
        "equality/wallet/puzzles/p2_delegated_puzzle.clvm",
        "equality/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "equality/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "equality/wallet/puzzles/p2_puzzle_hash.clvm",
        "equality/wallet/puzzles/rl_aggregation.clvm",
        "equality/wallet/puzzles/rl.clvm",
        "equality/wallet/puzzles/sha256tree_module.clvm",
        "equality/wallet/puzzles/singleton_top_layer.clvm",
        "equality/wallet/puzzles/did_innerpuz.clvm",
        "equality/wallet/puzzles/decompress_puzzle.clvm",
        "equality/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "equality/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "equality/wallet/puzzles/block_program_zero.clvm",
        "equality/wallet/puzzles/test_generator_deserialize.clvm",
        "equality/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
    ]
)

clvm_include_files = set(
    ["equality/wallet/puzzles/create-lock-puzzlehash.clvm", "equality/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "equality/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to equality/wallet/puzzles, but not added to `wallet_program_files`
        """
