...
from equality.protocols.full_node_protocol import RespondBlock
from equality.server.server import EqualityServer
from equality.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
from equality.types.peer_info import PeerInfo
from equality.util.ints import uint16, uint32, uint64
...
class TestWalletSimulator:
    ...
    #         outbound: List[WSEqualityConnection] = wallet.server.get_outgoing_connections()
