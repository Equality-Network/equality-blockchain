...
from equality.server.ssl_context import equality_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"equality_{service_name}"
        ...
        equality_ca_crt, equality_ca_key = equality_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = EqualityServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (equality_ca_crt, equality_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for EqualityServer to be closed")
