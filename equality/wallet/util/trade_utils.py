...
from equality.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "equality" in cc_discrepancies:
                    cc_discrepancies["equality"] = cc_discrepancies["equality"] + diff
                else:
                    cc_discrepancies["equality"] = diff
