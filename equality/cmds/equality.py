...
from equality.cmds.configure import configure_cmd
from equality.cmds.farm import farm_cmd
from equality.cmds.init import init_cmd
from equality.cmds.keys import keys_cmd
from equality.cmds.netspace import netspace_cmd
from equality.cmds.plots import plots_cmd
from equality.cmds.show import show_cmd
from equality.cmds.start import start_cmd
from equality.cmds.stop import stop_cmd
from equality.cmds.wallet import wallet_cmd
...
@click.group(
    help=f"\n  Manage equality blockchain infrastructure ({__version__})\n",
    epilog="Try 'equality start node', 'equality netspace -d 192', or 'equality show -s'",
...
@cli.command("version", short_help="Show equality version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs equality daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from equality.daemon.server import async_run_daemon
    import asyncio
