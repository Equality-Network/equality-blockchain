...
from equality.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "59888"
            testnet_introducer = "beta1_introducer.equalitychain.org"
            testnet = "testnet7"
            ...
            mainnet_port = "9888"
            mainnet_introducer = "introducer.equalitychain.org"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running equality services for changes to take effect")
