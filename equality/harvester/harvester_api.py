...
from equality.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from equality.harvester.harvester import Harvester
from equality.plotting.plot_tools import PlotInfo, parse_plot_info
from equality.protocols import harvester_protocol
from equality.protocols.farmer_protocol import FarmingInfo
from equality.protocols.protocol_message_types import ProtocolMessageTypes
from equality.server.outbound_message import make_msg
...
from equality.util.api_decorators import api_request, peer_required
from equality.util.ints import uint8, uint32, uint64
from equality.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSEqualityConnection
    ):
        """
